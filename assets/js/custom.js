jQuery(document).ready(function($) {
	...
	$("a[data-pretty^='prettyPhoto']").prettyPhoto({social_tools:false});
	//portfolio hover
	$('ul.da-thumbs > li').hoverdir();
	
  $(".da-animate a").mouseover(function () {
	$(".da-thumbs li article", this).stop().animate({"padding-top": "10p%"},{ queue: false, duration: 500 }, "slow");
  });
	$(".da-animate a").mouseout(function(){
		$(".da-thumbs li article", this).stop().animate({"padding-top": "25p%"}, "slow");
	});
